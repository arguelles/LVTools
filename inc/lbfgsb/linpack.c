/* linpack.f -- translated by f2c (version 20100827).
...
//!!!: These implementations do not handle the case of reverse indexing
int daxpy_(integer* n, doublereal* alpha, doublereal* x,
		   integer* incx, doublereal* y, integer* incy)
{
	assert(*incx>0 && *incy>0 && "negative increments are not implemented");
...
int dscal_(integer *n, doublereal *alpha, doublereal *x,
		   integer *incx)
{
	assert(*incx>0 && "negative increments are not implemented");
